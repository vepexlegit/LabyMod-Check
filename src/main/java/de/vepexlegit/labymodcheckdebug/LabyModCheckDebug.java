package de.vepexlegit.labymodcheckdebug;

import de.vepexlegit.labymodcheckdebug.commands.LabyModCheckCommand;
...
@Mod(modid = "labymodcheckdebug", version = "1.0")
public class LabyModCheckDebug {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        ClientCommandHandler.instance.registerCommand(new LabyModCheckCommand());
    }
    ...
    public void onGuiMainMenuInit(GuiScreenEvent.InitGuiEvent.Post event) {
        if (event.gui instanceof GuiMainMenu) {
            if (LabyModCheck.INSTANCE.isEnabled()) {
                if (isLabyModActive()) {
